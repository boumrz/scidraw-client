...
const Toolbar = observer(() => {
    ...
    return (
        <div className="toolbar">
            ...
            <button className="toolbar__btn eraser" onClick={() => toolState.setTool(new Eraser(canvasState.canvas, canvasState.socket, params.id))}/>
            <button className="toolbar__btn line" onClick={() => toolState.setTool(new Line(canvasState.canvas, canvasState.socket, params.id))}/>
